...
- <span style="color:#dabfff">**Visualizations**</span>: Various visualizations were created using **[Matplotlib](https://matplotlib.org/)** ![#dabfff](https://via.placeholder.com/15/dabfff/000000?text=) and **[Seaborn](https://seaborn.pydata.org/)** ![#dabfff](https://via.placeholder.com/15/dabfff/000000?text=) to illustrate the relationship between compound sentiment scores and stock price changes, including scatter plots and violin plots.<br>

- <span style="color:#dabfff">**Statistical Tests**</span>: 
   - The <span style="color:#dabfff">**Shapiro-Wilk test**</span> from **[SciPy](https://www.scipy.org/)** ![#dabfff](https://via.placeholder.com/15/dabfff/000000?text=) assessed whether compound sentiment scores and percentage changes in stock prices followed a normal distribution. A significant p-value (< 0.05) would indicate a deviation from normality.<br>

   - A <span style="color:#dabfff">**Spearman rank correlation test**</span> was conducted using **[SciPy](https://www.scipy.org/)** ![#dabfff](https://via.placeholder.com/15/dabfff/000000?text=) to evaluate the monotonic relationship between sentiment scores and stock prices. A significant p-value (< 0.05) suggests a meaningful relationship.<br>

   - The <span style="color:#dabfff">**Pearson correlation test**</span>, also from **[SciPy](https://www.scipy.org/)** ![#dabfff](https://via.placeholder.com/15/dabfff/000000?text=), examined the linear relationship between sentiment scores and stock prices. A low p-value (< 0.05) indicates a significant correlation, meaning changes in one variable are associated with changes in the other.
